...
Grammar rules below are **inferred from attested examples only**. Darnassian is not a fully constructed language; Blizzard provided limited phrases. Patterns are noted where multiple examples support a rule. Speculative extensions are marked [speculative].

## Morphology

### Compounding

Darnassian makes heavy use of compounding. Morphemes are concatenated to form complex words, particularly in names and titles.

**Pattern: Modifier + Head**

- Kal + dorei = Kaldorei ("Star" + "Children of" = "Children of the Stars")
- Quel + dorei = Quel'dorei ("Noble" + "Children of" = "Children of Noble Birth")

The `-dorei` suffix is a productive morpheme meaning "children of" or "people of," comparable to an ethnonym-forming suffix.

**Pattern: Element + Drassil (World Tree Names)**
...
- Shan'do = "Shan" (honored) + "do" (teacher/elder) = "Honored Teacher"
- Thero'shan = "Thero" (beloved) + "shan" (student/learner) = "Beloved Student"

Note: The morpheme `shan` appears in both titles with apparently different meanings. This is analyzed as two distinct morphemes that happen to share a form (homophony), or as a relational term whose specific gloss depends on its position in the compound.

### Apostrophe Usage

Apostrophes mark morpheme boundaries within compound words:

- Quel'dorei = Quel + dorei
- Shan'do = Shan + do
- Thero'shan = Thero + shan
- Ru'shem = Ru + shem
- Tor ilisar'thera'nal = ilisar + thera + nal (internal boundaries in a multi-morpheme word)

Apostrophes appear primarily in:
1. Two-morpheme compounds (Quel'dorei, Shan'do)
2. Multi-morpheme verbal/nominal complexes (ilisar'thera'nal)

They do **not** appear in all compounds — `Kaldorei`, `Teldrassil`, `Nordrassil` lack apostrophes. The distribution may reflect:
- Phonological criteria (apostrophe after certain vowel-consonant patterns)
...
- Elune-adore ("Elune" + "be with you" — deity name + blessing verb)
- Andu-falah-dor ("Let" + "balance" + "be restored" — three-element phrase)
- Fandu-dath-belore ("Who" + "goes" + "there" — three-element question)

Hyphens appear to mark **syntactic phrase boundaries**, while apostrophes mark **morphological word-internal boundaries**. This is a consistent distinction.

## Syntax

### Imperative Constructions

Two imperative formulas are attested:
...
`Fandu-dath-belore?` ("Who goes there?") is the only attested question. `Fandu` may be an interrogative pronoun ("who"), but this is [speculative] given only one example.

### Word Order

The extremely limited sample prevents firm conclusions about word order. Observed patterns:

- **Imperative + Object/Complement**: Andu-falah-dor (Let + balance + be-restored), Tor ilisar'thera'nal (Let + enemies + beware)
- **Modifier + Head in compounds**: Kal-dorei, Quel-dorei, Tel-drassil, Nor-drassil
- **Deity name precedes blessing**: Elune-adore

The modifier-head pattern in compounds might suggest a head-final tendency, but this cannot be confirmed for full sentences.
...
10. **Apostrophe phonotactic tendency**: Pre-apostrophe morphemes overwhelmingly end in sonorants (nasals: *Shan'*, *An'*, *Min'*; liquids: *Quel'*, *Belor'*, *Sar'*; vowels: *Ru'*, *Asha'*, *Alara'*) or fricatives (/*ʃ*/: *Alash'*, *Ash'*). Across 30+ apostrophe-containing words, only one counterexample exists: *Rhut'van* (pre-apostrophe /t/, an oral stop). This ~97% tendency mirrors the stricter constraint in Thalassian and suggests a shared Proto-Elven phonotactic constraint against morpheme boundaries after oral stops. This constraint is **absent** from both Zandali (where oral stops freely precede the apostrophe: *Lok'* /k/, *Mak'* /k/, *Zeb'* /b/) and Orcish (*Lok'* /k/, *Mak'* /k/, *Gul'* /l/), indicating it is an **elven innovation** rather than inherited from Proto-Troll-Elven — see elven-comparative.html for cross-family comparison.
...
The corpus is extremely small (~25–30 items). Many "words" are isolated from single contexts, making it impossible to determine:
...
| *-naar* | Astranaar, Dolanaar, Sylvanaar, Satyrnaar, Faronaar | "Town / settlement" | Moderate–High (5 independent attestations; parallel to *Aran*) |
...
**Aran vs. -naar**: The forms *Aran* and *-naar* both appear to mean "town/settlement" but differ phonologically. Seven attestations of *Aran* and five of *-naar* make this one of the best-attested Darnassian morphemes. Four hypotheses:
...
4. **Phonologically conditioned allomorphy**: *-naar* appears after vowel-final stems (Astra-, Dola-, Sylva-, Faro-) while *Aran* appears after consonant-final stems (Ameth', Bashal', Loreth', Morlos', Ordil', Shal') or as a separate word (Tethris Aran). This distribution is consistent with phonological conditioning: *-naar* is the form after vowels, *Aran* is the form after consonants. This is a cleaner analysis than the metathesis/vowel-lengthening story in Hypotheses 1 and 3, as it predicts the allomorph distribution without invoking ad hoc sound changes. **Counterexample**: *Satyrnaar* — the stem *Satyr-* ends in the consonant /r/ yet takes *-naar* rather than *Aran*. This is the sole exception to the phonological conditioning pattern. However, *Satyr* is likely a Common (non-Darnassian) borrowing — the word "satyr" exists in Common/English as a mythological creature name, and its presence in a Darnassian place name may reflect post-Sundering Common influence rather than native Darnassian compounding. If *Satyr* is a Common borrowing grafted onto a Darnassian toponymic suffix, it would be exempt from Darnassian phonological conditioning rules — making *Satyrnaar* an exception that proves the rule for native stems. The corpus otherwise shows a clean split: all 8 *Aran* attestations follow consonant-final stems, and 4 of 5 *-naar* attestations follow vowel-final stems
...
- *Faronaar* (Legion fortress on the Broken Shore) is the 5th attestation of *-naar*; the Broken Shore was originally the night elven region *Thal'dranath*, making Faronaar a plausible night elven place name ending in *-naar*. Crucially, the stem *Faro-* is vowel-final, consistent with the Hypothesis 4 phonological conditioning pattern (*-naar* after vowels)
...
The Haranir are confirmed to descend from dark trolls/night elves (*The Art of Midnight*, pg. 125): "those who would eventually become the haranir split from them and journeyed deep below the ground." This origin is further confirmed **in-plot** during the "Curse of Ula'tek" campaign (patch 12.1.0), where the Haranir elder **Hagar** reveals that "elves and trolls share common ancestry, having descended from the haranir that chose to remain on the surface" — making the Haranir the **ancestral stock** from which both elves and trolls diverged, not merely an offshoot. This recontextualization is critical for cognate analysis: under the ancestral-stock model, Hara'ni retains proto-forms as the default, while the elven and troll languages innovated sound changes (such as /h/ → ∅). This makes cognate retention in Hara'ni the *expected* outcome rather than something requiring special explanation, and strengthens the prior probability that observed phonological matches reflect genuine cognates rather than coincidence. While 16,000 years typically erases cognate recognition beyond the most deeply entrenched morphemes, several candidates warrant investigation.
...
**Confidence: Moderate** (upgraded from Low–Moderate) for *-nir* as a shared Proto-Troll-Elven collective suffix. The phonological match is exact and the morphological function (nominal suffix in proper names) is consistent. The in-plot confirmation that Haranir are the ancestral stock of elves and trolls (Hagar, "Curse of Ula'tek" campaign) increases the prior probability that shared morphemes reflect genuine cognate retention rather than coincidence. The semantic gap ("people" vs. "bringer/bearer") and small sample size remain limitations.
...
**Confidence: Moderate–High** (upgraded from Moderate) for *Har'* ↔ *Aran* as a shared Proto-Troll-Elven morpheme. The semantic match is exact, the /h/ → ∅ sound change is typologically natural, and two independent lines of evidence now support the sound change: (1) the /h/ distribution gradient across five elven-family languages (Round 30), and (2) the in-plot confirmation from Hagar ("Curse of Ula'tek" campaign) that Haranir are the ancestral stock, making /h/ retention in Hara'ni the default and /h/ loss in elven languages the innovation. The main limitation remains the absence of additional /h/-initial ↔ zero-initial cognate pairs beyond this single root.
...
**Confidence: Moderate** (upgraded from Low–Moderate) for *Shul'* ↔ *Shal* as a shared Proto-Troll-Elven root meaning "shadow/darkness." The consonantal match is exact and the semantics are precise. The in-plot confirmation from Hagar ("Curse of Ula'tek" campaign) that Haranir are the ancestral stock increases the prior probability that this shared root reflects genuine cognate retention rather than coincidence. This candidate remains independent of the /h/ → ∅ hypothesis, providing an independent line of evidence. The Darnassian meaning is inferred (not confirmed) and short CVC forms increase coincidence probability, but the exact semantic match across an independent semantic domain strengthens the case.
...
**Confidence: Moderate** (upgraded from Low–Moderate) for *-athir* as a shared Proto-Troll-Elven morpheme meaning "memory/remnant." The phonological match is exact (/æθɪr/ in both languages), the semantic match is confirmed in Hara'ni, and the three Nazjatar attestations provide converging evidence. The in-plot confirmation from Hagar ("Curse of Ula'tek" campaign) that Haranir are the ancestral stock increases the prior probability that this shared morpheme reflects genuine cognate retention. The Darnassian meaning is unconfirmed, the short morpheme length increases coincidence probability, and the *-athra* variant remains unexplained. The identification of *Kal'methir* as a Darnassian (not Nazja) form strengthens the cognate analysis by placing *-athir* / *-ethir* in the Darnassian layer.
...
**Confidence for /h/ → ∅ as a systematic elven sound change**: **Moderate–High** (upgraded from Moderate). The gradient distribution across five languages is strongly consistent with progressive /h/ loss, and the in-plot confirmation from Hagar ("Curse of Ula'tek" campaign) that Haranir are the ancestral stock confirms the directionality: Hara'ni retains ancestral /h/ as the default, while the elven languages innovated /h/ → ∅. The main limitation remains the absence of additional /h/-initial ↔ zero-initial cognate pairs beyond *Har'/Aran*.
...
|-----------|---------------|------------|--------------|--------------|
| *-nir* collective suffix | Shared suffix | **Moderate** (upgraded) | Exact phonological match; consistent function in proper names; ancestral-stock confirmation increases prior | Semantic gap ("people" vs. "bringer/bearer"); small sample |
| *Har'* ↔ *Aran* "settlement" | Shared root with /h/ loss | **Moderate–High** (upgraded) | Exact semantic match; /h/ → ∅ supported by gradient + ancestral-stock confirmation | Only one /h/ ↔ ∅ cognate pair found; could be limited to this root |
| *Shul'* ↔ *Shal* "shadow" | Shared root with vowel shift | **Moderate** (upgraded) | Exact semantic match "shadow"; identical /ʃ_l/ skeleton; independent of /h/→∅; ancestral-stock confirmation | Darnassian meaning inferred; short CVC; possible homophony with kinship *Shal'* |
| *-athir* "memory" | Shared suffix | **Moderate** (upgraded) | Confirmed semantics in Hara'ni; 3 Darnassian attestations; ancestral-stock confirmation | Darnassian meaning unconfirmed; short morpheme; *-athra* variant unexplained || *Aln-* ↔ *\*ala-* "essence" | Shared root with *-n* suffix | Very Low–Low | Coherent semantic framework; /al-/ onset shared | Extra *-n* unexplained; semantic gap significant |
| *-mara* "balance" | Shared suffix | Very Low | Exact phonological match | No Zandali semantic evidence; /mara/ is a common syllable |

**Overall assessment**: The convergence of four plausible cognate pairs — *-nir* (collective suffix), *Har'/Aran* (settlement root), *Shul'/Shal* (shadow root), *-athir* (memory suffix) — across four independent semantic domains (morphology, toponymy, vocabulary, suffix semantics) is more than would be expected by chance for languages separated by ~16,000 years. The in-plot confirmation from Hagar ("Curse of Ula'tek" campaign, patch 12.1.0) that Haranir are the **ancestral stock** from which both elves and trolls diverged significantly strengthens the cognate analysis: under this model, Hara'ni retention of proto-forms is the expected default, and observed phonological matches are more likely to reflect genuine cognate retention than coincidence. The /h/ distribution gradient across five elven-family languages (Hara'ni ~20% > Nazja ~4% > Darnassian <1% > Thalassian/Shalassian 0%) independently supports the /h/ → ∅ sound change required by the *Har'/Aran* analysis, and the ancestral-stock model confirms the directionality of this change. The identification of *Shul'/Shal* and *-athir* is particularly significant because neither requires the /h/ → ∅ change, providing independent lines of evidence for deep genetic relationship.

**Critical test**: If additional Hara'ni–Elven cognate pairs can be identified that share the /h/ → ∅ correspondence (Hara'ni initial /h/ ↔ Elven zero), this would significantly strengthen the *Har'/Aran* analysis and the overall case for cognate identification. A systematic search of all Hara'ni /h/-initial words against Darnassian and Thalassian vowel-initial words found no additional /h/ → ∅ pairs beyond *Har'/Aran*, suggesting that if the correspondence is genuine, it may be limited to this single root or require more data to confirm. The /h/ gradient analysis (Round 30) and the ancestral-stock confirmation from Hagar (Round 48) independently support systematic /h/ loss in the elven branch even without additional cognate pairs.

**Confidence: Moderate–High** (upgraded from Moderate) that at least two of the four top candidates (*-nir*, *Har'/Aran*, *Shul'/Shal*, *-athir*) reflect genuine Proto-Troll-Elven cognates; **High** confidence (upgraded from Moderate–High) that at least one does. The upgrade reflects the in-plot ancestral-stock confirmation from Hagar ("Curse of Ula'tek" campaign), which increases the prior probability that observed phonological matches between Hara'ni and elven languages reflect genuine cognate retention rather than coincidence.
...
|----------|------------|---------|-------|
| Darnassian | *Thas'talah* | Night elven glade | *Thas* = "forest" + *'talah* = *tal* "death" + *-ah* (nominalizer) → "forest of death" |
...
**Cross-reference with Investigation 14 (*-ah* suffix)**: The element *'talah* in *Thas'talah* is not opaque — it connects to the *-ah* nominalizer analyzed in Investigation 14. If *talah* = *tal* "death" + *-ah* (nominalizer), then *Thas'talah* = "forest of death" or "death-forest" — a semantically coherent name for a glade (cf. the "dark" or "haunted" connotations of many forested areas in WoW). This provides a complete translation for *Thas'talah* and an additional attestation context for the *-ah* suffix.

**Structural parallel with Thalassian**: Both *Thas'talah* and Thalassian *Thas'alah* = "Light of the Forest" follow the same compounding pattern: *Thas'* + [*X*-ah form], where *X* is a root nominalized by *-ah*. This is consistent with a productive compounding pattern: [toponymic morpheme] + [nominalized root].
...
**UPDATED Round 56**: A potential Zandali cognate has been identified: *-darah* in the loa name *Akil'darah* (Patch 12.1.0). The consonantal skeleton /d-r-h/ is identical to *-dorah*, and the /o/ → /a/ vowel shift is consistent with Zandali's /a/-dominance. If confirmed, this would extend the *-dor* family to four languages and provide the second cross-family morpheme (after *-da*) shared between Zandali and the elven languages. **Confidence: Low–Moderate** for the Zandali connection (single attestation, no confirmed gloss); see Zandali grammar.md Investigation 13 for full analysis.

**Cross-reference**: Shalassian grammar.md Investigation 5; Zandali grammar.md Investigation 13; elven-comparative.html (potential addition to *-dor* morpheme family table).
