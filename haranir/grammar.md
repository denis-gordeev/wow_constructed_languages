...
### No Confirmed Genetic Relationships

Hara'ni shows no confirmed genetic relationship to any other WoW language family:

- **Not elven**: No shared morphemes with Darnassian/Thalassian/Nazja; different phonological profile
- **Not troll (Zandali)**: No shared morphemes despite physical similarities (tusks)
- **Not titan-forged**: Haranir are not titan-forged; the *-dar* suffix is likely borrowed
- **Not Aqir-descended**: No confirmed shared morphemes with nerubian/qiraji
- **Not Shath'Yar**: No shared morphemes; apostrophe pattern differs (medial vs. initial)

### Areal Features

Hara'ni shares two areal features with neighboring Khaz Algar languages:
