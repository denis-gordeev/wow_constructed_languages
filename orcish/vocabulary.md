...
All entries below are attested in World of Warcraft in-game dialogue, NPC speech, quest text, or official Blizzard sources. No invented words are included. Etymologies inferred from compound analysis are marked with an asterisk (*); where multiple analyses exist, alternatives are noted.
...
- Apostrophes mark morpheme boundaries (e.g., *Lok'tar*, *Mak'gora*, *Aka'Magosh*, *Kosh'harg*, *Gul'dan*).
