...
| Shath'Yar | Old Gods and their servants | [shath-yar/](shath-yar/) | Very Low — names and whispers |
...
| Nerglish (Murloc/Jinyu/Ankoan/Kobyss) | Murlocs, Jinyu, Ankoan, Kobyss | [earthen/](earthen/#10-kobyss-and-the-murlocjinyuankoan-language-family) | Variable — Nerglish has iconic vocalizations and 2 self-designations (*gmmmlmrmrgmg*, *Mmmurlok*); Jinyu have 30+ proper names and 1 attested word (*Onoho* = "Deep Shadow"); Ankoan have 5 proper names; Kobyss show linguistic regression with only 3–5 Common words ("Animate bones", "Devour", "Violence") — the only known case of language loss in WoW |
