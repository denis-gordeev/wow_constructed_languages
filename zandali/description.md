...
| Open linguistic investigations | 12 | Investigation 1 (ergative vs. object agreement, Low–Moderate), Investigation 2 (*-aru*/-ura*, Low–Moderate), Investigation 3 (*ney* ↔ *-ne*, Moderate), Investigation 4 (*alanke* vs. *alai*, Low), Investigation 5 (*Noa* zero-derivation, Moderate–High), Investigation 6 (*-da* kinship suffix, Low–Moderate), Investigation 8 (*no* connective, Low–Moderate), Investigation 7 (*Bwon'* death prefix, Low–Moderate), Investigation 9 (*-watha* bidirectional, Low–Moderate), Investigation 10 (*-jai* suffix, Low–Moderate), Investigation 11 (*gokinye* decomposition, Low–Moderate), Investigation 12 (*-tek* in Ula'tek — cross-language parallels with Shath'Yar *tek* "skull", Sethrak *-thek*, nerubian *-tekhi*; Old God substrate hypothesis at Low–Moderate) |
