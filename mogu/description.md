...
- **Pandaren:** The Mogu enslaved the Pandaren for millennia. Some Pandaren place names may have Mogu origins; the element *shan* in *Mogu'shan* may have been borrowed into Pandaren vocabulary. The extent of Mogu influence on Pandaren is unknown but likely significant given the duration of Mogu rule.
- **Titan / Titan-forged languages:** The Mogu were created by Ra-den, a Titan Keeper. Their language may share roots or structural features with other Titan-created languages. The Mogu'shan Vaults are a Titan facility, and the name *Mogu'shan* may reflect Titan naming conventions.
- **Zandali (Zandalari Troll):** The Zandalari allied with the Mogu during the *Mists of Pandaria* storyline. *Daakara*, a Zandalari-sponsored Mogu leader, has a name that may be Zandali in origin rather than Mogu. The two peoples had cultural exchange but their languages appear distinct.
- **Common:** Mogu NPCs speak Common in-game. This is a game mechanic, not a lore indication that the Mogu have no native tongue.

## Key Phonological Features

- **Harsh consonants**: /g/, /k/, and /ʃ/ are prominent, giving the language a commanding, aggressive quality consistent with Mogu martial culture.
...
Mogu is a **very poorly attested** constructed language. The known corpus consists of:
