...
- [ ] Search for additional /h/ → ∅ cognate pairs in Thalassian or Nazja — Hara'ni /h/-initial words could correspond to Thalassian/Nazja vowel-initial words (these languages may preserve reflexes lost in Darnassian); /h/ gradient analysis (Round 30) supports systematic /h/ loss but no additional cognate pairs found yet — **COMPLETED Round 31**: Systematic search of all Hara'ni /h/-initial words against Darnassian, Thalassian, Nazja, Shalassian found no additional /h/ → ∅ pairs beyond *Har'/Aran*; novel /h/-retention observation: Hara'ni *Hagar* ↔ Nazja *Haghazed* (Very Low confidence)
- [ ] Test *dorah* semantics — confirm *dor* "crown" → *dorah* "valor/honor" derivation by searching for additional *dorah* contexts beyond the 4 known attestations; *daldorah* (Celebras incantation) identified as potential compound of *dal* + *dorah* (Very Low–Low confidence) — **COMPLETED Round 31**: Third Darnassian attestation added (*Thara dormil dorah*, Priestess of Elune); all three Darnassian *dorah* attestations occur in ritual/sacred contexts; 5 total *dorah* contexts now documented
- [ ] Test *-athir* cognate by searching for additional /-θɪr/ place names across elven languages — if *Alathir* = "memory of light" and *Kal'methir* = "memory of the stars", other *-athir* compounds may exist in Darnassian or Thalassian place name corpora — **COMPLETED Round 31**: No additional /-θɪr/ place names found; cross-family *-thir* parallels documented (nerubian *Krik'thir*, Shath'Yar *K'thir*) but assessed as independent
- [ ] Investigate *-athir*/*-athra* vowel alternation — *Lemor'athra* uses /-æθrə/ while *Alathir* uses /-æθɪr/; could reflect case marking, noun class, or dialectal variation; requires additional data — **COMPLETED Round 31**: Four hypotheses tested (case marking, number marking, phonological conditioning, different morpheme); none confirmed; Low–Moderate confidence maintained
