...
- [ ] Investigate Hara'ni–Elven cognate *Har'* "village" ↔ Darnassian *Aran*/*-naar* "town/settlement" — Low–Moderate confidence; systematic search found no additional /h/-initial ↔ zero-onset cognate pairs beyond *Har'/Aran*; correspondence may be limited to this single root; see Darnassian grammar.md Investigation 13 Candidate B
...
- [ ] Search for additional /h/ → ∅ cognate pairs in Thalassian or Nazja — Hara'ni /h/-initial words could correspond to Thalassian/Nazja vowel-initial words (these languages may preserve reflexes lost in Darnassian)
- [ ] Test *dorah* semantics — confirm *dor* "crown" → *dorah* "valor/honor" derivation by searching for additional *dorah* contexts beyond the 4 known attestations
