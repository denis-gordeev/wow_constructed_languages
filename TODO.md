...
- [ ] Investigate Vrykul *uul*/*buul* relationship — **RESOLVED Round 39**: Independent derivation preferred at Moderate confidence; *uul* ← ON úlfr (wolf), *buul* ← ON ból (lair); identical /uːl/ rime is convergent; see Vrykul grammar.md Investigation 2
- [ ] Investigate Vrykul *Mj-* onset pattern — **RESOLVED Round 39**: Phonological onset, not morpheme, at High confidence; *Mjor* and *Mjul* have divergent ON etymologies; see Vrykul grammar.md Investigation 3
- [ ] Test Vrykul VSO base order hypothesis — V-initial imperatives are categorical (6/6); if additional declarative phrases are found, SVO vs. VSO can be distinguished; see Vrykul grammar.md Investigation 1
