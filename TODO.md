...
- [ ] Investigate Hara'ni–Elven cognate *-nir* ↔ Darnassian *-anir*/*-nir* — Low–Moderate confidence; requires additional attestations or confirmed gloss for Darnassian *-anir* suffix to confirm "people/ones of" interpretation; **strengthened by in-plot confirmation** (Hagar, "Curse of Ula'tek" campaign) that haranir are ancestral stock of both elves and trolls; see Darnassian grammar.md Investigation 13 Candidate A
- [ ] Investigate Hara'ni–Elven cognate *Har'* "village" ↔ Darnassian *Aran*/*-naar* "town/settlement" — **SIGNIFICANTLY UPDATED Round 30**: Confidence upgraded from Low–Moderate to **Moderate**; /h/ distribution gradient across 5 elven-family languages (Hara'ni ~20% > Nazja ~4% > Darnassian <1% > Thalassian/Shalassian 0%) independently supports /h/ → ∅ as a systematic elven sound change; two surviving Nazja /h/-initial names (*Heth'Jatar*, *Haghazed*) interpreted as retentions; **strengthened by in-plot confirmation** (Hagar, "Curse of Ula'tek" campaign) that haranir are ancestral stock of both elves and trolls; see Darnassian grammar.md Investigation 13 Candidate B
...
- [ ] Re-evaluate Hara'ni–Elven cognate confidence levels in light of in-plot ancestry confirmation — Hagar's revelation (patch 12.1.0) that haranir are the ancestral stock of both elves and trolls strengthens the genetic relationship from "deeply divergent branch" to "potential ancestral language"; consider upgrading *Har'/Aran* and *Shul'/Shal* confidence from Moderate/Low–Moderate to Moderate/Moderate
