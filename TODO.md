...
- [x] Research additional Drust Stele inscription content (blocked by web access issues) — **PARTIALLY COMPLETED**: identified all 10 Drust Stele names (Conflict, The Tree, The Circle, Constructs, The Ritual, The Three, Breath Into Stone, Sacrifice, The Cycle, The Flayed Man, Protectors of the Forest); recovered text for Constructs stele; confirmed all steles are pictographic descriptions in Common, NOT Drust-language inscriptions; 6 steles still missing text content (requires wiki access)
...
- [ ] Recover full text of remaining 6 Drust Stele inscriptions (The Three, Breath Into Stone, Sacrifice, The Cycle, The Flayed Man, The Ritual, Protectors of the Forest) — requires wiki access
- [ ] Add audio pronunciation guide links where available (blocked — wiki audio resources currently inaccessible)
- [ ] Investigate the ankoan/jinyu/murloc language family for potential kobyss-language connections (requires ankoan naming data from BfA Nazjatar content)
