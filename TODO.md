...
- [ ] Investigate Shath'Yar negation allomorphy (*maq* vs *noq*) — **SIGNIFICANTLY UPDATED Round 21**: Extended to three-way negation system — *og* (existential/nominal negation, 2 attestations), *maq* (verbal negation, 3rd person), *noq* (verbal negation, 1st person); see Shath'Yar grammar.md Investigation 5; Low–Moderate confidence for three-way system
...
- [ ] Investigate Zandali *no* connective in loa names (*Elortha no Shadra*, *Eraka no Kimbul*, *Ueetay no Mueh'zala*) — function (genitive, vocative, possessive?) and cross-family comparison with Thalassian *no* = "to/all"; see Zandali grammar.md Investigation 6B
- [ ] Test Darnassian *Aran*/*-naar* phonological conditioning hypothesis — search for vowel-final + *Aran* or consonant-final + *-naar* counterexamples in place name data
- [ ] Add Zandali phonological pattern analysis: CV'CV naming template for Amani NPCs, blood troll phonological divergence, /a/-dominance hierarchy by morpheme type, *-ara/ari/aru* vowel alternation family
- [ ] Investigate Zandali *Akunda* as potential *-da* evidence beyond kinship — if *Akunda* = *Akun* + *-da*, this would extend *-da* to a "spirit/being" classifier, countering baby-talk convergence hypothesis
