...
- [ ] Investigate Shath'Yar auxiliary verb system — **SIGNIFICANTLY UPDATED Round 24**: Three-way auxiliary distinction proposed (*agth* obligative, *gag* emphatic, *qi'*/*wgah* simple future); *agth* may also function as perfective auxiliary with prophetic perfect reading (*Zuq agth kyth* = "You have seen"); Low–Moderate confidence for functional distinction; see Shath'Yar grammar.md Investigation 4
