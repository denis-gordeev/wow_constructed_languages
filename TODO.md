...
- [ ] Add Kalimag and Taur-ahe to appropriate comparative HTML files — Kalimag has non-human phonological parallels with Shath'Yar (/θ/ prevalence, apostrophe compounding, CʔCVC templates); Taur-ahe shares apostrophe compounding with Zandali and celestial vocabulary with Titan/Vrykul; both are currently absent from all three comparative files
- [ ] Add Nerglish jinyu analysis to alien-comparative.html — currently mentioned as "independent language family" but not analyzed despite 30+ jinyu proper names and unique murloc→jinyu→kobyss linguistic trajectory
- [ ] Cross-reference Hara'ni *-dar* suffix with Titan-forged-comparative.html — *Harandar* contains potential Titan toponymic loan; not currently in titan-forged comparative
- [ ] Test *-mara* = "balance" in Zandali — if Shaol'mara and Kul'amara contain *-mara*, this confirms the Hara'ni cognate (Darnassian Investigation 13, Candidate D)
- [ ] Search for additional *-ah* suffix pairs beyond (tal/talah, al/alah, fal/falah) — Investigation 14 predicts more exist; check Nazja vocabulary for *-ah* reflexes
- [ ] Code remaining Shath'Yar confirmed phrases syntactically — ~20 phrases still uncoded from Zek'voz, Vol'zith, Armageddon, and Mote of Cosmic Truth sources; could further strengthen word order analysis or reveal new patterns
