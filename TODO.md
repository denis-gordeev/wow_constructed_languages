...
- [ ] Investigate Proto-Elven *-ah* derivational suffix — **SIGNIFICANTLY UPDATED Round 20**: Systematic analysis added as Darnassian Investigation 14; three cognate pairs (*tal*/*talah*, *al*/*alah*, *fal*/*falah*) analyzed as nominalizer/stative resultative; one tentative Nazja reflex identified (*Nazj-*/*Nazja*, Low–Moderate confidence); updated in elven-comparative.html Correspondence 7; see Darnassian grammar.md Investigation 14
...
- [x] Code remaining Shath'Yar confirmed phrases syntactically — **PARTIALLY DONE Round 20**: 3 of ~16 uncoded phrases now coded: *ULL vera skish!!* (S-Copula-Pred, Vol'zith), *Kulaq w'ajj, hwa-ksh brraglac!* (biclausal V-Adv/S-V, Armageddon), *Skitsh qi'uthik illith!* (PP-V-S locative fronting, Vol'zith); total coded phrases upgraded from 40+ to 43+; new locative fronting pattern identified; ~13 phrases remain uncoded
...
## Completed This Round (2026-07-03, Round 20)
