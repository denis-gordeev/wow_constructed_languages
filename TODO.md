...
- [ ] Analyze Shalassian *An-* prefix in *Tor ilisar'thera'nal* — officially classified as Darnassian but used by Thalyssra; if Shalassian, provides additional *An-* evidence
- [ ] Investigate Shalassian *Rath* spell family — *Rath* → *Rath-domaas* → *Rath-anu'tanos* shows systematic compounding; may be first attested Shalassian derivational paradigm
- [ ] Test Shalassian *-dora* suffix — appears in *Erana-dora* ("thousand-thanks") and *Fal'adora* (temple); if *-dora* = "grace/thanks," first confirmed suffix beyond *-dorei*
...
- [ ] Investigate Dwarven *-modan*/*Modr* relationship — *Khaz Modan*, *Thor Modan*, *Dun Modr* share *Mod-* root; if *-modan* and *-modr* are allomorphs, this is a productive Dwarven toponymic suffix
- [ ] Investigate Dwarven *-grim* element across titan-forged family — *Baelgrim* (Earthen), *Bjarngrim* (Vrykul), *Orgrim* (Orcish), *Grim Batol* (Dwarven); shared morpheme or Norse design convention?
...
- [ ] Cross-reference Shalassian *Fal-*/Darnassian *falah* cognate in elven-comparative.html — if added as Set 19, would be fifth cognate set; Very Low–Low confidence; requires more semantic precision
- [ ] Map initial-apostrophe nerubian names by context — four names (*Y'tekhi*, *A'zak*, *Ix'lar*, *Ix'zek*) may reflect Shath'Yar substrate; *Y'tekhi* underwent Old Blood transformation; analysis added to nerubian grammar.md; Very Low confidence; testable with new data
