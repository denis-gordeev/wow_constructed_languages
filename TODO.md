...
- [ ] Update HTML vocabulary files (nerubian, ethereal, earthen) with new names and data from wiki verification
- [ ] Add nerubian scroll text analysis to nerubian/grammar.md
- [ ] Update alien-comparative.html with nerubian scroll text data and faction name analysis
- [ ] Update titan-forged-comparative.html with new Earthen names (pre-TWW names, Thraegar, Dhar Oztan, Thor Modan)
- [ ] Research the *-ar* suffix as a potential nerubian faction-designation morpheme (appears in Anub'ar, Hath'ar, Nerub'ar, Ahn'kahar, Nerub-ar Palace)
- [ ] Investigate whether *En'kilah* adds a new prefix *En-* to the nerubian toponymic system (parallel to *Ahn-* and *Azj-*)
- [ ] Investigate the *-oc* / *-roc* element in Earthen names (Goggeroc, Leikaroc) — potential Earthen morpheme
- [ ] Investigate the Arabic-inspired naming pattern in ethereal names (Salhadaar, Haramad, Ameer, Bilaal, Razaan, Durzaan, Nezhar) — deliberate Blizzard design pattern or genuine ethereal-language phonological tendency?
