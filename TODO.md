...
- [ ] Recover full text of remaining 6 Drust Stele inscriptions (The Three, Breath Into Stone, Sacrifice, The Cycle, The Flayed Man, The Ritual, Protectors of the Forest) — requires wiki access — **COMPLETED**: all texts recovered; "The Three" was an error (does not exist as a separate stele)
- [ ] Add audio pronunciation guide links where available (blocked — no official WoW pronunciation guide found; wiki audio resources currently inaccessible; Blizzard has never published an official pronunciation guide for constructed languages)
...
- [ ] Investigate the *Hara-* root meaning: does it mean "people/we" or "call/song" or both? — requires more Hara'ni data points from future TWW/Midnight content
- [ ] Investigate whether the *-nir* / *-ni* / *-ti* suffix set is productive beyond the *Hara-* root — requires more Hara'ni data points
- [ ] Research additional Haranir NPC names from TWW Undermine patch and Midnight expansion — Orweyna's story continues
- [ ] Investigate the *-ia* pattern in female Haranir names (Ruia, Ney'leia, On'hiea) — possible feminine suffix or Blizzard naming aesthetic
- [ ] Investigate the *Greenspeaker* title and its potential relationship to Drust *Thornspeaker* — parallel druidic traditions or contact borrowing?
- [ ] Analyze Haranir–nerubian geographic proximity for potential loanwords — Haranir live near Azj-Kahet but no shared morphemes confirmed yet
