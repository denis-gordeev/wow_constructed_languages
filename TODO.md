...
- [ ] Test potential privative suffix *-ka* in Shath'Yar — *mazzka* = "eyeless" (*mazz* + *-ka* "without") in *Poq'yith mazzka* = "crooked eyeless serpent"; if confirmed, parallels Hara'ni *-ka* agentive suffix; Very Low–Low confidence
- [ ] Investigate *og* homophony — existential negation "no" (*Og h'iwn*) vs. potential existential copula "there is" or locative preposition "in/at" in the Mote of Cosmic Truth phrase (*Shuul og i agthu* = "There is a great..."); requires additional data to resolve
