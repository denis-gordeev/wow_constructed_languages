...
- [ ] Investigate Shath'Yar auxiliary verb system — **SIGNIFICANTLY UPDATED Round 28**: Investigation 12 added with systematic *wgah* vs. *qi'* distribution analysis; four hypotheses tested (register variation falsified by G'huun data; person conditioning not supported; syntactic position conditioning at Low–Moderate confidence); key finding: *qi'* never appears with intervening elements between subject and verb, while *wgah* appears with negation (*wgah qam*); proposed refined four-way future system: *qi'* synthetic prefix, *wgah* analytic auxiliary, *agth* obligative, *gag* emphatic; see Shath'Yar grammar.md Investigation 4 and Investigation 12
