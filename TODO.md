...
- [ ] Investigate Proto-Elven *-ah* derivational suffix — **SIGNIFICANTLY UPDATED Round 29**: Fourth *-ah* pair identified (*dor* → *dorah* "crown" → "valor/honor"); *dor* is first non-/l/-final root, demonstrating *-ah* attaches regardless of root-final consonant; *Thas'* compounding paradigm expanded to 3 members (*Thas'talah*, *Thas'alah*, *Thas'dorah*); confidence upgraded from Low–Moderate to **Moderate**; see Darnassian grammar.md Investigation 14
...
- [ ] Investigate Hara'ni–Elven cognate *-athir* "memory" ↔ Darnassian/Nazja *-athir*/*-ethir* — **NEW Round 30**: Confirmed semantics in Hara'ni (*Har'athir* = Village of Memory); three Darnassian attestations in Nazjatar spire names (*Alathir*, *Lemor'athra*, *Kal'methir*) share identical /-θɪr/ consonantal skeleton; phonologically clean (both languages have /θ/); does NOT require /h/ → ∅ sound change; *-athir*/*-athra* vowel alternation unexplained; Low–Moderate confidence; see Darnassian grammar.md Investigation 13 Candidate F
...
- [ ] Search for additional /h/ → ∅ cognate pairs in Thalassian or Nazja — Hara'ni /h/-initial words could correspond to Thalassian/Nazja vowel-initial words (these languages may preserve reflexes lost in Darnassian); /h/ gradient analysis (Round 30) supports systematic /h/ loss but no additional cognate pairs found yet
- [ ] Test *dorah* semantics — confirm *dor* "crown" → *dorah* "valor/honor" derivation by searching for additional *dorah* contexts beyond the 4 known attestations; *daldorah* (Celebras incantation) identified as potential compound of *dal* + *dorah* (Very Low–Low confidence)
- [ ] Test *-athir* cognate by searching for additional /-θɪr/ place names across elven languages — if *Alathir* = "memory of light" and *Kal'methir* = "memory of the stars", other *-athir* compounds may exist in Darnassian or Thalassian place name corpora
- [ ] Investigate *-athir*/*-athra* vowel alternation — *Lemor'athra* uses /-æθrə/ while *Alathir* uses /-æθɪr/; could reflect case marking, noun class, or dialectal variation; requires additional data
