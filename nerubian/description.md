...
- **Shath'Yar (Old God)**: The initial apostrophe in *Y'tekhi* (confirmed Old Blood ascension) and *A'zak* are consistent with Old God phonological influence; the *Ix'-* names (*Ix'lar*, *Ix'zek*) may reflect a native nerubian prefix rather than Shath'Yar substrate (see grammar.md Initial-Apostrophe Names investigation for full sub-pattern analysis); no direct Shath'Yar loanwords are confirmed
